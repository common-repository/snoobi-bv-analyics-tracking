...
Version: 1.0
Copyright: 2016 Snoobi B.V.
License: GPLv2

Copyright (C) 2016 Snoobi B.V.
...
function snoobianalyticsplugin_location_callback() {
        printf(
			...
			We recommend the footer as that ensures the complete web page is loaded before the tracking script runs.
			',
...
function snoobianalyticsplugin_options_page() {
	?><!-- fp -->
        <div class="wrap">
            ...
            <form method="post" action="options.php" id='snoobiform'>
<style>
#snoobiform td { vertical-align: top; }
#snoobiform th { vertical-align: top; }
</style>
            <?php
